package com.llw.study.network.interceptor;

import com.llw.study.network.INetworkRequiredInfo;
import com.llw.study.utils.EasyDate;
...
public class RequestInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        String nowDateTime = EasyDate.getDateTime();
        //构建器
